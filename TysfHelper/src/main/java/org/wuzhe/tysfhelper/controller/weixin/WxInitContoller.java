...
import org.wuzhe.tysfhelper.hanlder.weixin.ClickHanlder;
import org.wuzhe.tysfhelper.hanlder.weixin.ScanHanler;
...
public class WxInitContoller {
	...
	@Resource
	private WxMessageHandler hanlder;
	@Resource
	private WxMenu menu;
	@Resource
	private ClickHanlder clickHanlder;
	@Resource
	private WxMessageHandler subscribeHanlder;
	@Resource
	private ScanHanler scanHanler;
	...
	public void WxHanlder(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		try {
			...
			.rule().event(WxConsts.EVT_SCAN).handler(scanHanler).end();
